...
//    private static String[] colors={"方片","草花","红桃","黑桃"};
     ...
     * @param request
     * @param model
     * @param userIds 用户ids，用户id作为键存储用户的牌
     * @return
     */
    @RequestMapping("/list")
    public String fapai(HttpServletRequest request, Model model,Integer[] userIds){
        getPokers();
